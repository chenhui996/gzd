/**
 * title: 自定义校验
 * description: 我们提供了 `validateStatus` `help` `hasFeedback` 等属性，你可以不通过 Form 自己定义校验的时机和内容。<br /><br />1. `validateStatus`: 校验状态，可选 'success', 'warning', 'error', 'validating'。<br />2. `hasFeedback`：用于给输入框添加反馈图标。<br />3. `help`：设置校验文案。
 */

import React from 'react';
import { SmileOutlined } from '@ant-design/icons';
import { Form, Input, Select } from 'gzd';
import { Cascader, DatePicker, InputNumber, Mentions, TimePicker, TreeSelect } from 'antd';;
